'''
Demo file for roundtable chat using Agents2 framework.
'''
...
chat=Interaction.RoundTable(roster=[a,b],username="User",context=mycontext,stream=True,summarizer_agent=[None,""],summarizer_mode=0)
chat.auto_debate(prompt="Debate prompt here", turns=10, stream=True)